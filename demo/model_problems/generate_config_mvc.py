...
for n_walks in n_walks_values:
    ...
    config["output"]["solutionFile"] = f"demo/model_problems/engine/solutions/meanvalue_{n_walks}.pfm"
    config["output"]["csvFilename"] = f"demo/model_problems/engine/solutions/meanvalue_{n_walks}.csv"
    
    # 生成文件名
    filename = os.path.join(output_dir, f"meanvalue_{n_walks}.json")
